    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Formulário de Registo |<small>Armadores</small></h2>
                        <div class="clearfix"></div>
                    ...
                    <div class="x_content">
                        ...
                        <div id="wizard" class="form_wizard wizard_horizontal">
                                ...
                                <li>
                                    <a href="#step-1">
                                        ...
                                        <span class="step_descr">
                                            Passo 1<br />
                                            <small>Dados pessoais/Tipo de armador</small>
                                        </span>
                                    </a>
                                </li>
                                <li>
                            ...
                            <form class="form-horizontal form-label-left" data-parsley-validate id="form" method="POST"
                                action="{{ route('fisher.register') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div id="step-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="name" required="required" value="{{ old('name') }}" minlength="3" class="form-control  "
                                                name="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="birthday" class="date-picker form-control" value="{{ old('birthday') }}" name="birthday"
                                    ...
                                    <div class="form-group row">
                                        <label for="bi" class="col-form-label col-md-3 col-sm-3 label-align">
                                            <span id="text-bi">Nº BI</span><span id="text-nif">NIF</span> <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="bi" class="form-control col" data-inputmask="'mask' : '999999999aa999'" value="{{ old('bi') }}" required="required" type="text" name="bi">
                                ...
                                <div id="step-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="tel" id="phone" data-inputmask="'mask' : '(+244)-\\999-999-999'" name="phone" value="{{ old('phone') }}" required="required"
                                                class="form-control ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
